    ...
    <div className="min-h-screen bg-background font-sans selection:bg-primary/10 flex flex-col relative overflow-hidden">
      ...
      <section className="flex-1 flex flex-col items-center justify-center py-32 px-6 text-center max-w-5xl mx-auto space-y-12 animate-in fade-in zoom-in-95 duration-700 relative z-10">
        <div className="inline-flex items-center rounded-full border border-indigo-200 bg-indigo-50/50 px-3 py-1 text-sm font-medium text-indigo-800 backdrop-blur-sm mb-4">
          ...
          522 Occupations | 5,885 Tasks | 5-Category Spectrum
        </div>
        ...
        <div className="space-y-6">
          ...
          <p className="text-xl md:text-2xl text-slate-600 font-light max-w-2xl mx-auto leading-relaxed">
            KI Kompass analyzes AI exposure at the task level — not just automatable or not, but <em>how</em>. With regulation built in.
          </p>
        </div>
            ...
            <Card className="hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border-slate-200 hover:border-blue-300 group h-full flex flex-col bg-white/60 backdrop-blur-md rounded-3xl overflow-hidden mt-8">
              ...
              <CardHeader className="pt-8 pb-4">
                ...
                <CardDescription className="text-base mt-3 leading-relaxed text-slate-600">
                  Browse 522 German occupations with 5-category AI exposure analysis. Compare across sectors.
                </CardDescription>
              </CardHeader>
              <CardContent className="flex-1">
                 <div className="flex flex-wrap gap-2 mt-2">
                   ...
                   <span className="text-[11px] font-semibold tracking-wide uppercase text-blue-600 bg-blue-50 px-3 py-1 rounded-full">5,885 Tasks</span>
                 </div>
              </CardContent>
            ...
            <Card className="hover:shadow-[0_20px_60px_-15px_rgba(79,70,229,0.3)] hover:-translate-y-2 transition-all duration-500 border-indigo-100 bg-white/90 backdrop-blur-xl group relative h-full flex flex-col rounded-3xl overflow-hidden shadow-xl ring-1 ring-indigo-50 z-10">
              ...
              <CardHeader className="pt-10 pb-4">
                ...
                <CardDescription className="text-lg mt-4 text-slate-600 leading-relaxed font-medium">
                  Deep dive into your specific daily tasks. See exactly which parts of your work are ripe for AI augmentation, automation, or protected by regulation.
                </CardDescription>
              </CardHeader>
              <CardContent className="flex-1">
                 <div className="space-y-3 mt-2">
                   <div className="flex items-center text-sm text-slate-500">
                     ...
                     5-category AI exposure spectrum
                   </div>
                   <div className="flex items-center text-sm text-slate-500">
                     <div className="w-1.5 h-1.5 rounded-full bg-indigo-400 mr-2" />
                     Personalized task-level breakdown
                   </div>
                   <div className="flex items-center text-sm text-slate-500">
                     <div className="w-1.5 h-1.5 rounded-full bg-indigo-400 mr-2" />
            ...
            <Card className="hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 border-slate-200 hover:border-teal-300 group h-full flex flex-col bg-white/60 backdrop-blur-md rounded-3xl overflow-hidden mt-8">
              ...
              <CardContent className="flex-1">
                 <div className="flex flex-wrap gap-2 mt-2">
                   ...
                   <span className="text-[11px] font-semibold tracking-wide uppercase text-teal-600 bg-teal-50 px-3 py-1 rounded-full">7 Sectors</span>
                 </div>
              </CardContent>
              <CardFooter className="pb-8">
                <Link href="/my-role">
